...
//            showRowNumber = false
    ...
    gridImplementations {
        ...
        jqgrid {
            ...
            /*
             * removed format array after encountering problems w/ Timestamp formatting; not clear exactly when these
             * are invoked and admittedly didn't spend much time trying to find out
             */
